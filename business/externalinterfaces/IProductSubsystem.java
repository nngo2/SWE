...
public interface IProductSubsystem {
	/**
	 * retrieves a twokey hashmap that consists of all products keyed on both
	 * name and id
	 */
	...
	/**
	 * retrieves list of catalog names; if this value is already in memory, it
	...
	/**
	 * gets a list of products from the database, based on catalog type; if list
	 * is already in memory then database read is avoided
	 */
	...
	/**
	 * reads the product object from the database using the product name using a
	 * database hit
	 */
